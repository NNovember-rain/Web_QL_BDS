									...
									<div>
										<div class="card-body p-5">
											<div class="mb-md-5 mt-md-4 pb-5 text-center">
												<h2 class="fw-bold mb-2 text-uppercase" style="color: violet">Login</h2>
												<p class="text-white-50 mb-5" style="color: violet">Please enter your login and password!</p>
												<form action="j_spring_security_check" id="formLogin" method="post">
													<div class="form-outline form-white mb-4">
														<label class="form-label" for="userName" style="color: violet">Email</label>
														<input type="text" class="form-control" id="userName" name="j_username" placeholder="Tên đăng nhập">
													</div>

													<div class="form-outline form-white mb-4">
														<label class="form-label" for="password" style="color: violet">Password</label>
													...
													<div class="form-check d-flex justify-content-center mb-5">
														...
														<div><label class="form-check-label" style="color: violet">
															Remember Password
														</label></div>
													</div>

													<p class="small mb-2 pb-lg-2" ><a  href="#!" style="color: violet">Forgot password?</a></p>

													<button type="submit" class="btn" style="color: violet">Đăng nhập</button>
												</form>
											...
											<div class="text-center">
												<p class="mb-0 tex-center account" style="color: violet">Don't have an account? <a href="#!"  style="color: mediumpurple">Sign Up</a></p>
											</div>
