            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="formContact">
                        <div class="row">
                            <div class="col">
                                <input type="text" id="name" name="fullName" class="form-control" placeholder="Họ và tên">
                                <div class="error-massage text-danger"></div>
                            </div>
                            <div class="col">
                        ...
                        <button class="btn btn-primary px-4 mt-3" id="sub">
                            Gửi liên hệ
                        </button>
                    </form>
                </div>
...
<script>
    ...
    function validateInput(){ // check field rỗng
        ...
        if(inputName.value===""){
            inputName.parentElement.querySelector(".error-massage").innerHTML=`Please enter your Name`;
            check=false;
        }else{
            inputName.parentElement.querySelector(".error-massage").innerText="";
        }
        if(inputPhone.value===""){
            inputPhone.parentElement.querySelector(".error-massage").innerHTML=`Please enter your Phone Number`;
            check=false;
        }else{
            inputPhone.parentElement.querySelector(".error-massage").innerText="";
        }
    }


    function sendContact(dataForm){
        $.ajax({
            type: "POST",
