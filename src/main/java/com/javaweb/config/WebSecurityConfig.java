...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // tạo một đối tượng để ta set thằng user được xử lí ở bước 1 và set tiếp cho nó mật khẩu đã được mã hóa ở bước 2
    // đối tượng này sẽ đươ sử dụng trong quá trình xác thực người dùng
    @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception {
                ...
                .authorizeRequests()
                        ...
                        .antMatchers("/login", "/resource/**", "/trang-chu", "/api/**","/contact/**").permitAll()
                .and()
